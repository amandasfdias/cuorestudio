    ...
    <>
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="max-w-sm mx-auto rounded-2xl">
          <DialogHeader>
            <DialogTitle className="font-display text-3xl font-bold tracking-tight text-center uppercase">
              Nova Receita
            </DialogTitle>
          </DialogHeader>
            ...
            {options.map((option) => {
              ...
              return (
                ...
                >
                  ...
                  <div>
                    <h3 className="font-display text-2xl uppercase tracking-wider text-foreground font-bold">
                      {option.title}
                    </h3>
